...
// Lazy initialization to avoid throwing during Next.js build
let _db: ReturnType<typeof createQueryBuilder<IntrospectedSchema>> | null = null;
...
function getDb() {
  ...
  _db = createQueryBuilder<IntrospectedSchema>({
    client,
    cache: {
...
export const db = new Proxy({} as ReturnType<typeof createQueryBuilder<IntrospectedSchema>>, {
  get(_target, prop) {
