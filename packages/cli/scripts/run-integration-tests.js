...
async function runVitest() {
  logIntegrationMessage('Running Vitest integration suite...');
...
async function main() {
  ...
  try {
    ...
    // Note: CLI integration tests don't need to seed test data
    // They create their own temporary tables for migration testing
