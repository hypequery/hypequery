...
// Run 'npx hypequery generate:schema' after configuring your database connection
...
`);
  ...
  if (hasValidConnection) {
    ...
    logger.indent('2. Run: npx hypequery generate:schema    (to generate schema types)');
