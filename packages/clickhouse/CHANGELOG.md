...
- 3e34e07: Group a condition's column so a trusted SQL expression cannot widen the
...
- 6c02ad6: Add explicit support for ClickHouse connections running under `readonly = 1`.
...
- ef890a3: Support `AbortSignal` on query, stream, and insert execution.
...
- d943a98: Add `close()` for graceful shutdown.
