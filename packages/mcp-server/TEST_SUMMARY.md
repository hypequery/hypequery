...
Comprehensive test suite for `@hypequery/mcp` with **114 passing tests** across 12 test files.
...
#### `canonical-query-schemas.test.ts` (5 tests)
...
1. ✅ **Unit Tests** - Complete (114 tests)
