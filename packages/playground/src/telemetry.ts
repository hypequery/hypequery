 ...
 * - Opt-out: HYPEQUERY_TELEMETRY_DISABLED=1 or DO_NOT_TRACK=1; auto-disabled
 *   in CI; entirely inert until an ingest endpoint is configured.
...
export class Telemetry {
   ...
   * Safe to call when disabled — it is then a no-op.
   */
