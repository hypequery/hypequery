...
<Callout type="info" title="ServeRequest headers are plain objects">
  ...
  <code>request.headers.get()</code>. If you want case-insensitive lookups, use
  <code>normalizeHeaderMap</code> from <code>@hypequery/serve</code> before reading headers.
</Callout>
