---
title: Builder-to-Serve Migration
description: Migrate direct query-builder code into the v0.1.x builder-first serve API.
---
...
<Callout type="info">
  This page documents migration into the v0.1.x builder-first Serve API. New projects should usually start in <a href="/docs/quick-start">Quick Start</a>. For the current execution model, read <a href="/docs/core-concepts">Core Concepts</a>.
</Callout>
