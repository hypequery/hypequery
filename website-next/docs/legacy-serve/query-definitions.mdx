...
description: Builder-first query definition patterns for the v0.1.x hypequery serve API.
---
...
<Callout type="info">
  This page documents the v0.1.x builder-first Serve API. For new projects, start with <a href="/docs/quick-start">Quick Start</a>. If you are migrating existing code, use <a href="/docs/migrate-legacy-serve-api">Migrate from v0.1.x Serve API</a>. For the current execution model, read <a href="/docs/core-concepts">Core Concepts</a>.
</Callout>
