---
title: Migrate from v0.1.x Serve API
description: Move from the v0.1.x builder-first serve API to object-style query definitions with serve({ queries }).
---
...
<Callout type="info">
  This guide is for migrating from the older serve API shown in <a href="/docs/legacy-serve/query-definitions">v0.1.x Serve API</a> to the current default path used in <a href="/docs/quick-start">Quick Start</a>.
</Callout>
...
- Keep the [v0.1.x Serve API](/docs/legacy-serve/query-definitions) open while migrating if you need to compare syntax
