---
title: Migrate from Builder to Serve
description: Add HTTP APIs and team features to your existing queries
---
...
4. **Configure caching** → [Caching Guide](/docs/caching)
...
**What if I need help?**
- Check [when to use serve](/docs/standalone-query-builder/when-to-use)
