...
<Callout type="info">
If you need the older builder-chained tenant APIs such as `.tenant(...)` and `.tenantOptional()`, see <a href="/docs/legacy-serve/multi-tenancy">Legacy Multi-Tenancy</a>.
</Callout>
...
- [Legacy Multi-Tenancy](/docs/legacy-serve/multi-tenancy)
