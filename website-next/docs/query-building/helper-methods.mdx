...
**Continue:** [Aggregations](/docs/query-building/aggregation) - Learn aggregation functions

**Or explore:**
- [SQL Expressions](/docs/query-building/sql-expressions) - Raw SQL and expressions
- [Query Builder API Reference](/docs/reference/query-builder-api) - Complete API documentation
