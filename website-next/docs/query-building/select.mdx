---
title: Select
description: Select and transform ClickHouse columns with a type-safe TypeScript query builder. Learn aliases, expressions, joins, and strongly typed result shapes.
---
