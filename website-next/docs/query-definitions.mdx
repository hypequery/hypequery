...
<Callout type="default">
  New to Serve? Start with the overview for deployment models, then dive into the Serve reference for every API surface.
</Callout>
...
- **[Schemas](/docs/schemas)** - Learn about input/output schemas for validation
- **[Authentication](/docs/authentication)** - Configure authentication strategies
- **[Multi-tenancy](/docs/multi-tenancy)** - Configure tenant isolation
- **[Caching](/docs/caching)** - Configure caching layer
</Callout>
