...
<Callout type="info">
  **New to Hypequery?** Start with the [Standalone Query Builder Setup](/docs/standalone-query-builder/setup) to learn the basics, then come here when you're ready to add HTTP APIs and team features.
