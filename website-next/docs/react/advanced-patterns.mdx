...
**Continue:** [Standalone Usage](/docs/standalone-usage/when-to-use) - Using the query builder without serve

**Or explore:**
- [React API Reference](/docs/reference/react-api) - Complete API documentation
- [Query Definitions](/docs/query-definitions) - Define reusable queries
