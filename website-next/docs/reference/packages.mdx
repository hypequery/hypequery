...
| `@hypequery/react` | TanStack Query-powered hooks (`useQuery`, `useMutation`) generated from your serve catalog (`define()` result / exported `api`) so React apps can call metrics with full typing. |
