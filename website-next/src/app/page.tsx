        ...
        <div className="bg-gray-50 py-16 dark:bg-gray-900">
          <div className="mx-auto max-w-7xl px-4 lg:px-6">
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              {/* Before - Raw SQL */}
              <div className="border-2 border-red-200 bg-white p-6 shadow-sm dark:border-red-800 dark:bg-gray-800">
                <div className="mb-4">
...
// ❌ Can't refactor safely`}
              ...
              {/* After - Type-safe */}
              <div className="border-2 border-green-200 bg-white p-6 shadow-sm dark:border-green-800 dark:bg-gray-800">
                <div className="mb-4">
