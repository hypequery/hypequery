...
export const seoFooterGroups: SeoLinkGroup[] = [
  {
    ...
    links: [
      ...
      { label: 'Type-Safe SQL', href: '/type-safe-sql-typescript' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'vs TypeORM', href: '/compare/hypequery-vs-typeorm' },
      { label: 'vs Metabase', href: '/compare/hypequery-vs-metabase' },
      { label: 'vs HTTP Interface', href: '/compare/hypequery-vs-clickhouse-http' },
      { label: 'vs Raw SQL', href: '/compare/hypequery-vs-raw-sql' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Prisma for ClickHouse', href: '/prisma-clickhouse' },
      { label: 'TypeORM for ClickHouse', href: '/typeorm-clickhouse' },
    ],
  },
  {
    title: 'Functions',
    links: [
      ...
      { label: 'toStartOfDay', href: '/clickhouse/functions/to-start-of-day' },
      { label: 'toStartOfInterval', href: '/clickhouse/functions/to-start-of-interval' },
      { label: 'uniq', href: '/clickhouse/functions/uniq' },
      { label: 'quantile', href: '/clickhouse/functions/quantile' },
      { label: 'groupArray', href: '/clickhouse/functions/group-array' },
      { label: 'dateDiff', href: '/clickhouse/functions/date-diff' },
      { label: 'arrayMap', href: '/clickhouse/functions/array-map' },
      { label: 'coalesce', href: '/clickhouse/functions/coalesce' },
    ],
  },
];
