...
Output schemas are optional. If you omit them, TypeScript infers the return type directly from your resolver, and the HTTP response still carries that fully typed payload.
