...
hypequery models your data using TypeScript schemas.
...
When you need to expose analytics outside your process, hypequery can generate an HTTP layer.

This includes:

- OpenAPI specifications
- Type-safe SDK clients
...
- ClickHouse is the execution engine, not the abstraction

---

**Next**: Learn about the [architecture](/docs/getting-started/architecture)
