...
**Continue:** [Quickstart](/docs/getting-started/quickstart) - Build your first analytics endpoint

**Or jump to:** [Type Generation](/docs/getting-started/type-generation) - Start building queries
