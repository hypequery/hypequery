...
**Continue:** [Architecture Tour](/docs/getting-started/architecture) - See how the pieces fit together

**Or jump to:** [Type Generation](/docs/queries/type-generation) - Start building queries
