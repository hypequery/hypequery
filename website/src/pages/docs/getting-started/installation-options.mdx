...
- ✅ **Named, reusable query definitions** - No more duplicating SQL logic
- ✅ **Input validation** - Zod schemas validate inputs automatically
- ✅ **Type inference** - Full type safety from definition to execution
- ✅ **Runtime flexibility** - Execute embedded or expose via HTTP
- ✅ **Authentication & multi-tenancy** - Built-in when you need it
- ✅ **Auto-generated OpenAPI** - HTTP layer with zero config

**[Continue to Quickstart →](/docs/getting-started/quickstart)**
...
**[Continue to Standalone Setup →](/docs/standalone/setup)**
