  ...
  <div class="flex items-start gap-4">
    ...
    <div class="flex-1 space-y-1">
      ...
      <p class="text-gray-700 mb-4">
        Choose your path (serve or standalone) and start building type-safe analytics in minutes.
      </p>
      <a
...
- **Inference for clients & agents** — Extract the same schema metadata to power API clients, agents, or cron jobs without copy/pasting types.
...
**Or jump to:** [Installation Options](/docs/getting-started/installation-options) - Choose your path and get started
