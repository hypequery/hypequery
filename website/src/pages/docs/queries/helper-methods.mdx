...
**Continue:** [Aggregations](/docs/queries/aggregations) - Learn aggregation functions

**Or explore:**
- [SQL Expressions](/docs/queries/sql-expressions) - Raw SQL and expressions
- [Query Builder API Reference](/docs/reference/query-builder) - Complete API documentation 
