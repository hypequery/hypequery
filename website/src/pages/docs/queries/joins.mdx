...
**Continue:** [Time Functions](/docs/queries/time-functions) - Work with dates and time

**Or explore:** [Join Relationships](/docs/queries/join-relationships) - Reusable join definitions 