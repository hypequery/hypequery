...
**Continue:** [Subqueries & CTEs](/docs/queries/subqueries-ctes) - Advanced query composition

**Or explore:** [Query Building](/docs/queries/query-building) - Review the core API
