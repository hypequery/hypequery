...
**Continue:** [SQL Expressions](/docs/queries/sql-expressions) - Use raw SQL when needed

**Or explore:** [Query Building](/docs/queries/query-building) - Review the fundamentals 
