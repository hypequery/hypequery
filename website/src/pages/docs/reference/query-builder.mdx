...
**Continue:** [Connection Options](/docs/reference/connection) - Configure ClickHouse connection

**Or explore:**
- [Building Queries](/docs/queries/query-building) - Learn query patterns
- [Serve API Reference](/docs/reference/serve) - serve framework API
