...
<Callout>
  Looking for the full API surface (global middlewares, auth, hooks, etc.)? See the
  <a class="font-semibold text-indigo-600 hover:text-indigo-500" href="/docs/reference/serve">Serve reference</a>
