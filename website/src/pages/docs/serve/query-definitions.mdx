...
The builder and config-object styles produce identical `ServeQueryConfig` values—pick whichever reads better for your team. See [Authentication](/docs/serve/authentication#auth-guards) for the full auth guards reference.
